...
conditions_texts = [d['conditions_description'] for d in data if d.get('conditions_description')]
...
candidate_description_texts = [d['candidate_description'] for d in data if d.get('candidate_description')]
